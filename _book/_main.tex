...
\NormalTok{features }\OtherTok{\textless{}{-}} \FunctionTok{apply}\NormalTok{(Pam50}\SpecialCharTok{$}\NormalTok{features,}\DecValTok{2}\NormalTok{,scale) }\SpecialCharTok{\%\textgreater{}\%} \FunctionTok{as.matrix}\NormalTok{()}
...
\NormalTok{external }\OtherTok{\textless{}{-}}\NormalTok{ Pam50}\SpecialCharTok{$}\NormalTok{external }\SpecialCharTok{\%\textgreater{}\%} \FunctionTok{as.matrix}\NormalTok{()}
...
\NormalTok{pred }\OtherTok{\textless{}{-}} \FunctionTok{GraphR\_pred}\NormalTok{(new\_df, res)}
\FunctionTok{head}\NormalTok{(pred)}
\end{Highlighting}
\end{Shaded}

\hypertarget{GraphRshinyApp}{%
\section{Shiny app and tutorial website}\label{GraphRshinyApp}}
